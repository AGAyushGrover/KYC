...
//       >
//         <h1 className="text-3xl font-bold text-blue-600 mb-6 text-center pt-6">
...
//     <h1 className="text-3xl font-bold text-blue-600 mb-4 pt-6">
//       Let us know about you!
//     </h1>

//     <div className="w-full max-w-3xl bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
//       <div className="max-h-[600px] overflow-y-auto pr-2"> {/* ✅ Make only this scroll */}
